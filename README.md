...
2. **Commit trigger** — On each commit, re-profile changed files, update `repo_data/current/python.json`, recompute metric deltas, and append to `repo_data/score_history.json`.x
